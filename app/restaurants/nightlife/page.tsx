...
const filters = [
  ...
  { label: 'Nightlife', icon: ChevronDown, active: true },
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto py-6 px-2 md:px-4">
        ...
        <div className="text-sm text-gray-600 mb-2">
          Mumbai &gt; Nightlife & Restaurants in Mumbai &gt; 1002+ Listings
        </div>
        <h1 className="text-2xl md:text-3xl font-bold mb-4">Best Nightlife & Restaurants in Mumbai - Order Food Online</h1>
